...
int main()
  { char palavra1[100], palavra2[100];
    ...
    if (strlen(palavra2) > strlen(palavra1))
      printf("\nA palavra %s não está contida em %s",palavra2,palavra1);
    else
         ...
         {  if (palavra1[i] == palavra2[0])
              {  qtd++;
                 ...
                 if (qtd == strlen(palavra2))
                   break; } } }
    if (qtd == strlen(palavra2))
      printf("\nA palavra %s está contida na palavra %s",palavra2,palavra1);
    else
      printf("\nA palavra %s não está contida na palavra %s",palavra2,palavra1);
    return 0;  }
